...
class Trap {
    ...
    getConfig() {
        switch (this.type) {
            case TRAP_TYPES.SPIKE: return TRAPS.SPIKE;
            case TRAP_TYPES.FIRE: return TRAPS.FIRE;
            case TRAP_TYPES.POISON: return TRAPS.POISON;
            case TRAP_TYPES.ICE: return TRAPS.ICE;
            case TRAP_TYPES.ROCK: return TRAPS.ROCK;
            case TRAP_TYPES.TELEPORT: return TRAPS.TELEPORT;
            default: return TRAPS.SPIKE;
        }
    }
    ...
    render(ctx) {
        ...
        if (this.flameHeight > 0) {
            ...
            const gradient = ctx.createRadialGradient(
                this.x, this.y - this.flameHeight / 2, 0,
                this.x, this.y - this.flameHeight / 2, this.flameHeight / 2
            );
            ...
            ctx.quadraticCurveTo(this.x - 8, this.y - this.flameHeight / 2, this.x, this.y - this.flameHeight + flicker);
